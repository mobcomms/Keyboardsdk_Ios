...
protocol ENKeyboardSoundViewControllerDelegate {
    func soundChange()
}

class ENKeyboardSoundViewController: UIViewController, ENViewPrsenter {
    ...
    var delegates: ENKeyboardSoundViewControllerDelegate?
