//
//  ENKeyboardInquiryViewController.swift
//  KeyboardSDK
//
...
class ENKeyboardInquiryViewController: UIViewController, WKUIDelegate, WKNavigationDelegate, UIScrollViewDelegate, WKScriptMessageHandler {
    
    public static func create() -> ENKeyboardInquiryViewController {
        let vc = ENKeyboardInquiryViewController.init(nibName: "ENKeyboardInquiryViewController", bundle: Bundle.frameworkBundle)
    ...
    func webViewLoad(){
        ...
        if ENSettingManager.shared.customerID == "" {
...
extension ENKeyboardInquiryViewController {
//     html a tag target
