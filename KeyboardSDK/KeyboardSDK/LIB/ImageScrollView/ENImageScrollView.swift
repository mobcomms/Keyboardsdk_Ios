...
@objc public protocol ENImageScrollViewDelegate: UIScrollViewDelegate {
    func imageScrollViewDidChangeOrientation(imageScrollView: ENImageScrollView)
}

open class ENImageScrollView: UIScrollView {
    ...
    @objc open weak var imageScrollViewDelegate: ENImageScrollViewDelegate?

    var imageSize: CGSize = CGSize.zero
    private var pointToCenterAfterResize: CGPoint = CGPoint.zero
    private var scaleToRestoreAfterResize: CGFloat = 1.0
    open var maxScaleFromMinScale: CGFloat = 4.0
    ...
    private func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ENImageScrollView.changeOrientationNotification), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
    ...
    @objc open func display(image: UIImage) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(ENImageScrollView.doubleTapGestureRecognizer(_:)))
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= minimumZoomScale * ENImageScrollView.kZoomInFactorFromMinWhenDoubleTap - 0.01 {
            setZoomScale(minimumZoomScale, animated: true)
        } else {
            let center = gestureRecognizer.location(in: gestureRecognizer.view)
            let zoomRect = zoomRectForScale(ENImageScrollView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale, center: center)
...
extension ENImageScrollView: UIScrollViewDelegate {
